...
The current implementation is to track the velocity error based on the pose difference and use a PD controller to scale this error and publish it to the low-level controller.
