...
x_bounds = (-1000,1000)
y_bounds = (-1000,1000)
padding = 0.5 #how far to stay left or right from an obstacle
...
def check_xy(coord):
    ...
    for i in OBSTACLES:
        if coord[0] >= (i[0] - padding) and coord[0] <= (i[1] + padding)\
              and coord[1] >= (i[2] - padding) and coord[1] <= (i[3] + padding):
            return i
    return False
